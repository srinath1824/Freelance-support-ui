...
function DeveloperDetails() {
    ...
    function createData(developer, technology, started, amount, experience, company, mobile, status) {
        return { developer, technology, started, amount, experience, company, mobile, status };
    }
    ...
    return (
        ...
        <DeveloperDetailsDialog open={open} handleClose={handleClose} setDialogDetails={setDialogDetails} showDelete={showDelete} dialogDetails={dialogDetails}/>
        </>
    )
}
